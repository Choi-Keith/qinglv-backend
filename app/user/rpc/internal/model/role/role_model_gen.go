...
func (m *defaultRoleModel) Insert(ctx context.Context, session sqlx.Session, data *Role) (sql.Result, error) {
	...
	return m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		if session != nil {
			return session.ExecCtx(ctx, query, data.Id, data.Name, data.DeletedAt, data.IsDel, data.Version)
		}
		return conn.ExecCtx(ctx, query, data.Id, data.Name, data.DeletedAt, data.IsDel, data.Version)
	}, qUserRoleIdKey)
}
...
func (m *defaultRoleModel) Update(ctx context.Context, session sqlx.Session, data *Role) (sql.Result, error) {
	...
	return m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		if session != nil {
			return session.ExecCtx(ctx, query, data.Name, data.DeletedAt, data.IsDel, data.Version, data.Id)
		}
		return conn.ExecCtx(ctx, query, data.Name, data.DeletedAt, data.IsDel, data.Version, data.Id)
	}, qUserRoleIdKey)
}
...
func (m *defaultRoleModel) UpdateWithVersion(ctx context.Context, session sqlx.Session, data *Role) error {
	...
	sqlResult, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		if session != nil {
			return session.ExecCtx(ctx, query, data.Name, data.DeletedAt, data.IsDel, data.Version, data.Id, oldVersion)
		}
		return conn.ExecCtx(ctx, query, data.Name, data.DeletedAt, data.IsDel, data.Version, data.Id, oldVersion)
	}, qUserRoleIdKey)
	if err != nil {
		return err
	}
...
func (m *defaultRoleModel) Delete(ctx context.Context, session sqlx.Session, id uint64) error {
	qUserRoleIdKey := fmt.Sprintf("%s%v", cacheQUserRoleIdPrefix, id)
